...
export const INDUSTRIES: Industry[] = [
  ...
  I({
    ...
    problems: [
      { id: "buying-blind", trades: ["pre-purchase inspection", "car inspection", "vehicle inspection", "car buying service"], label: "Buying a car blind", statement: "Most buyers cannot assess a vehicle and discover the expensive problems after the money has moved", pain: 86, solvedBy: ["local-service", "consulting", "content", "digital-product"], alternative: "kicking the tyres and hoping", segments: ["car-buyers"] },
      { id: "presentation", label: "Vehicles that look neglected", statement: "Cars sell for hundreds less and lease returns cost hundreds more purely because of presentation", pain: 74, solvedBy: ["local-service", "productized-service"], alternative: "a quick wash the morning of viewing", trades: ["detailing", "detail", "valeting", "car wash", "car cleaning", "ceramic coating", "paint correction", "interior cleaning", "reconditioning"], handsOn: true, segments: ["commuters", "enthusiasts", "small-fleets"] },
      { id: "garage-trust", trades: ["quote checking", "repair advice", "mechanic advice"], label: "Not knowing if the quote is honest", statement: "Drivers can't evaluate a repair quote, so they either overpay or delay necessary work", pain: 80, solvedBy: ["consulting", "content", "education"], alternative: "getting three quotes and picking the middle", segments: ["car-buyers", "commuters"] },
      ...
      { id: "fleet-downtime", trades: ["fleet maintenance", "fleet servicing", "mobile mechanic"], label: "Vehicles off the road", statement: "For a small fleet, a vehicle out of action is direct lost revenue and nobody is tracking maintenance", pain: 78, solvedBy: ["local-service", "service", "software"], alternative: "reacting to breakdowns", segments: ["small-fleets"] },
    ],
  }),
