...
export const INDUSTRIES: Industry[] = [
  I({
    ...
    problems: [
      { id: "where-to-go", label: "Not knowing where to go", statement: "People waste entire days at spots that were never going to work, because local knowledge lives in people's heads rather than anywhere findable", pain: 78, solvedBy: ["content", "digital-product", "local-service", "education"], alternative: "guessing from old forum posts and generic maps" },
      { id: "gear-confusion", label: "Gear paralysis", statement: "Beginners overspend on the wrong equipment because every review is written by someone being paid by a brand", pain: 72, solvedBy: ["content", "affiliate", "education", "consulting"], alternative: "reading sponsored reviews and asking in shops" },
      { id: "skill-gap", label: "Nobody to teach them", statement: "Skills that used to pass down through family now have no obvious teacher, so people quit after a few frustrating attempts", pain: 76, solvedBy: ["education", "local-service", "content", "community"], alternative: "trial and error, or giving up" },
      { id: "trip-planning", label: "Planning takes longer than the trip", statement: "Working out permits, conditions, access and timing takes hours of scattered research for a single outing", pain: 70, solvedBy: ["digital-product", "service", "software", "local-service"], alternative: "cobbling together government sites and blog posts" },
      { id: "gear-maintenance", label: "Gear failing when it matters", statement: "Expensive equipment gets ruined by poor storage and maintenance nobody was ever taught", pain: 64, solvedBy: ["local-service", "education", "content"], alternative: "replacing it, or ignoring the problem" },
    ],
  ...
  I({
    ...
    problems: [
      { id: "no-time", label: "No time for the standard advice", statement: "Almost all training advice assumes an hour in a gym, which is impossible for most people's actual schedule", pain: 84, solvedBy: ["education", "digital-product", "content", "service", "community"], alternative: "starting, missing sessions, and quitting again" },
      { id: "no-accountability", label: "Nobody notices if they stop", statement: "People know what to do and still don't do it, because nothing and nobody is holding them to it", pain: 80, solvedBy: ["community", "service", "consulting", "software"], alternative: "an app that gets deleted after two weeks" },
      { id: "conflicting-info", label: "Contradictory advice everywhere", statement: "Every source contradicts the last, so people never commit to a plan long enough for it to work", pain: 72, solvedBy: ["education", "content", "consulting", "digital-product"], alternative: "endlessly switching programmes" },
      { id: "injury-fear", label: "Fear of doing it wrong", statement: "People avoid training entirely because they're scared of injuring themselves with bad form and no supervision", pain: 76, solvedBy: ["education", "service", "local-service", "content"], alternative: "avoiding anything that feels difficult" },
      { id: "gym-retention", label: "Members quietly disappearing", statement: "Small gyms lose most new members within three months and rarely have a system to notice or intervene", pain: 74, solvedBy: ["consulting", "agency", "software", "service"], alternative: "hoping direct debits keep running" },
    ],
  ...
  I({
    ...
    problems: [
      { id: "editing-time", label: "Editing eats all the time", statement: "Creators spend far more hours editing than creating, which caps how much they can publish and burns them out", pain: 82, solvedBy: ["service", "productized-service", "agency"], alternative: "editing at midnight themselves, or posting less" },
      { id: "no-ideas", label: "Running out of ideas", statement: "Consistency dies not from laziness but from staring at a blank content calendar every week", pain: 74, solvedBy: ["service", "digital-product", "consulting", "software"], alternative: "copying whatever is trending and hoping" },
      { id: "repurposing", label: "One video, one platform", statement: "Long-form content never gets cut up for other platforms, so most of its value is thrown away", pain: 72, solvedBy: ["productized-service", "agency", "service"], alternative: "meaning to do it and never doing it" },
      { id: "on-camera-fear", label: "Freezing on camera", statement: "Genuine experts produce stilted, lifeless content because nobody taught them how to talk to a lens", pain: 70, solvedBy: ["consulting", "education", "service"], alternative: "avoiding video entirely" },
      { id: "monetisation", label: "Audience but no income", statement: "Creators build real audiences and then have no idea how to turn attention into money without wrecking trust", pain: 76, solvedBy: ["consulting", "education", "digital-product"], alternative: "waiting for a brand deal that never comes" },
    ],
  }),
  ...
  I({
    ...
    problems: [
      { id: "no-shows", label: "Tradespeople who don't turn up", statement: "The single most common complaint isn't price or quality — it's that people don't show up, don't call back, and don't finish", pain: 88, solvedBy: ["local-service", "service"], alternative: "chasing three quotes and hoping one replies" },
      { id: "small-jobs", label: "Jobs too small for anyone to want", statement: "Nobody profitable wants a two-hour job, so small tasks pile up for years", pain: 74, solvedBy: ["local-service", "productized-service"], alternative: "living with it" },
      { id: "seasonal-crunch", label: "Everything needed at once", statement: "Seasonal work all comes due in the same three weeks and every provider is booked", pain: 72, solvedBy: ["local-service", "service"], alternative: "booking late and paying more" },
      { id: "trust", label: "Letting a stranger into the house", statement: "People delay booking because they can't tell who is trustworthy from a listing", pain: 78, solvedBy: ["local-service", "content"], alternative: "asking neighbours and waiting" },
      { id: "turnover-speed", label: "Empty property costing money", statement: "Every day between tenants is lost rent, and coordinating cleaning and repairs is a job in itself", pain: 82, solvedBy: ["local-service", "productized-service", "service"], alternative: "the landlord doing it personally at weekends" },
    ],
  ...
  I({
    ...
    problems: [
      { id: "admin-drowning", label: "Admin eating billable hours", statement: "Owners spend evenings on invoicing, chasing and filing instead of the work that actually earns", pain: 84, solvedBy: ["service", "productized-service", "consulting", "software"], alternative: "doing it badly at night, or not at all" },
      { id: "quote-slowness", label: "Losing work by quoting slowly", statement: "Jobs go to whoever responds first, and small businesses routinely take days", pain: 80, solvedBy: ["service", "software", "consulting"], alternative: "losing the job and never knowing why" },
      { id: "no-process", label: "Everything lives in one person's head", statement: "Nothing is written down, so the business cannot take a holiday or hire anyone", pain: 76, solvedBy: ["consulting", "productized-service", "education"], alternative: "the owner never taking time off" },
      { id: "cash-visibility", label: "No idea what's actually profitable", statement: "Revenue is visible, profit per job isn't, so businesses grow their least profitable work", pain: 78, solvedBy: ["consulting", "service", "software", "education"], alternative: "checking the bank balance and guessing" },
      { id: "chasing-payment", label: "Getting paid late", statement: "Invoices go unpaid for months because chasing feels rude and nobody owns the task", pain: 80, solvedBy: ["service", "productized-service", "software"], alternative: "waiting, then writing it off" },
    ],
  ...
  I({
    ...
    problems: [
      { id: "generic-teaching", label: "Teaching that ignores the individual", statement: "Group instruction moves at one pace, so anyone slightly off that pace quietly falls behind", pain: 80, solvedBy: ["service", "education", "local-service", "consulting"], alternative: "extra classes that repeat the same explanation" },
      { id: "intermediate-wall", label: "Nothing for the middle stage", statement: "Beginner material is everywhere and advanced material assumes too much, leaving people stuck in between", pain: 76, solvedBy: ["digital-product", "education", "content", "community"], alternative: "rewatching beginner content indefinitely" },
      { id: "practice-gap", label: "Knowing but not doing", statement: "Learners consume enormous amounts of material without ever practising, so nothing sticks", pain: 78, solvedBy: ["community", "education", "software", "service"], alternative: "collecting more courses" },
      { id: "exam-technique", label: "Knowing the subject, failing the test", statement: "Students understand the material and still lose marks on technique, timing and question reading", pain: 84, solvedBy: ["service", "digital-product", "education"], alternative: "more revision of content they already know" },
      { id: "training-cost", label: "Training priced for large companies", statement: "Small employers need the same skills as big ones but every provider is priced for a corporate budget", pain: 72, solvedBy: ["education", "consulting", "digital-product"], alternative: "learning on the job and making expensive mistakes" },
    ],
  }),
  ...
  I({
    ...
    problems: [
      { id: "decision-fatigue", label: "The daily what's-for-dinner problem", statement: "The cooking isn't the hard part — deciding, shopping and not wasting food is", pain: 76, solvedBy: ["digital-product", "content", "service", "community"], alternative: "takeaway and a fridge of wasted vegetables" },
      { id: "restriction-cooking", label: "Every recipe needs rewriting", statement: "One allergy or condition makes almost all published recipes unusable, and adapting them is a research project", pain: 84, solvedBy: ["digital-product", "education", "content", "service"], alternative: "eating the same six safe meals forever" },
      { id: "small-catering", label: "Events too small for caterers", statement: "Thirty-person events fall between cooking it yourself and hiring a caterer who wants a minimum order", pain: 74, solvedBy: ["local-service", "events", "service"], alternative: "supermarket platters and stress" },
      { id: "menu-photos", label: "Food that photographs badly", statement: "Small food businesses lose custom to phone photos taken under strip lighting", pain: 68, solvedBy: ["local-service", "service", "productized-service"], alternative: "using the same bad photos for years" },
      { id: "scaling-recipes", label: "Recipes that don't scale", statement: "Home cooks going commercial discover their recipes break at volume and their costs are unknown", pain: 72, solvedBy: ["consulting", "education", "digital-product"], alternative: "trial and error with expensive ingredients" },
    ],
  ...
  I({
    ...
    problems: [
      { id: "left-alone", label: "Animal alone all day", statement: "Owners work long hours and know their animal is under-exercised and under-stimulated", pain: 82, solvedBy: ["local-service", "service"], alternative: "asking a neighbour and feeling guilty" },
      { id: "conflicting-training", label: "Contradictory training advice", statement: "Training content contradicts itself constantly, and owners make problems worse trying to fix them", pain: 78, solvedBy: ["education", "local-service", "content", "consulting"], alternative: "watching more videos and staying stuck" },
      { id: "holiday-care", label: "Nobody to leave them with", statement: "Trips get cancelled or animals get boarded somewhere the owner doesn't trust", pain: 80, solvedBy: ["local-service", "marketplace"], alternative: "expensive kennels or imposing on family" },
      { id: "grooming-access", label: "Grooming waitlists", statement: "Appointments are booked weeks out and awkward breeds get turned away", pain: 70, solvedBy: ["local-service", "productized-service"], alternative: "attempting it at home badly" },
      { id: "vet-costs", label: "Preventable problems getting expensive", statement: "Small issues become large vet bills because owners didn't know what to watch for", pain: 76, solvedBy: ["content", "education", "digital-product"], alternative: "reacting once it's serious" },
    ],
  ...
  I({
    ...
    problems: [
      { id: "buying-blind", label: "Buying a car blind", statement: "Most buyers cannot assess a vehicle and discover the expensive problems after the money has moved", pain: 86, solvedBy: ["local-service", "consulting", "content", "digital-product"], alternative: "kicking the tyres and hoping" },
      { id: "presentation", label: "Vehicles that look neglected", statement: "Cars sell for hundreds less and lease returns cost hundreds more purely because of presentation", pain: 74, solvedBy: ["local-service", "productized-service"], alternative: "a quick wash the morning of viewing" },
      { id: "garage-trust", label: "Not knowing if the quote is honest", statement: "Drivers can't evaluate a repair quote, so they either overpay or delay necessary work", pain: 80, solvedBy: ["consulting", "content", "education"], alternative: "getting three quotes and picking the middle" },
      { id: "project-stalls", label: "Projects that stall", statement: "Restoration projects stop at the first genuinely hard step and sit for years", pain: 68, solvedBy: ["education", "content", "community", "consulting"], alternative: "the car sitting under a cover" },
      { id: "fleet-downtime", label: "Vehicles off the road", statement: "For a small fleet, a vehicle out of action is direct lost revenue and nobody is tracking maintenance", pain: 78, solvedBy: ["local-service", "service", "software"], alternative: "reacting to breakdowns" },
    ],
  }),
  ...
  I({
    ...
    problems: [
      { id: "skill-plateau", label: "Stuck at the same level", statement: "Players grind for hundreds of hours without improving because nobody has ever reviewed what they're doing wrong", pain: 74, solvedBy: ["service", "education", "content", "community"], alternative: "watching pro streams and hoping it transfers" },
      { id: "hardware-waste", label: "Spending badly on hardware", statement: "Buyers overspend on the wrong components because every recommendation is affiliate-driven", pain: 76, solvedBy: ["consulting", "content", "affiliate", "local-service"], alternative: "copying a build from a sponsored video" },
      { id: "stream-production", label: "Streams that look amateur", statement: "Small streamers lose viewers in the first ten seconds to bad audio and layout they can't diagnose themselves", pain: 72, solvedBy: ["service", "productized-service", "consulting"], alternative: "using a free overlay and wondering why nobody stays" },
      { id: "prep-time", label: "Preparation takes longer than playing", statement: "Game masters spend hours preparing sessions and burn out on the admin, not the game", pain: 74, solvedBy: ["digital-product", "content", "community", "software"], alternative: "improvising badly or cancelling sessions" },
      { id: "finding-players", label: "No reliable group", statement: "People want to play regularly and can't assemble a group that actually shows up", pain: 70, solvedBy: ["community", "marketplace", "events"], alternative: "abandoned group chats" },
    ],
  }),
  ...
  I({
    ...
    problems: [
      { id: "practice-plateau", label: "Practising without progressing", statement: "Self-taught players repeat what they can already do and never address the specific thing holding them back", pain: 72, solvedBy: ["service", "education", "content"], alternative: "another free lesson video" },
      { id: "unfinished-tracks", label: "Nothing ever gets finished", statement: "Producers accumulate hundreds of unfinished projects because mixing and finishing were never taught", pain: 78, solvedBy: ["service", "education", "digital-product", "community"], alternative: "starting yet another track" },
      { id: "bad-audio", label: "Audio that drives listeners away", statement: "Listeners leave over sound quality long before they leave over content", pain: 74, solvedBy: ["service", "productized-service", "consulting"], alternative: "assuming a better microphone will fix it" },
      { id: "booking-risk", label: "Booking a performer sight unseen", statement: "Organisers commit money to musicians they've never heard live and often regret it", pain: 72, solvedBy: ["marketplace", "local-service", "content"], alternative: "asking the venue who they've used before" },
      { id: "gear-choices", label: "Home studio money wasted", statement: "Beginners buy the wrong equipment first and hit the same wall regardless", pain: 66, solvedBy: ["consulting", "content", "affiliate", "education"], alternative: "buying what a sponsored video recommended" },
    ],
  }),
  ...
  I({
    ...
    problems: [
      { id: "fit", label: "Nothing fits properly", statement: "Off-the-peg clothing fits almost nobody well, and most people have never had anything altered", pain: 78, solvedBy: ["local-service", "service", "education"], alternative: "buying bigger and hoping" },
      { id: "no-system", label: "A wardrobe with no system", statement: "People own plenty and still have nothing to wear, because nothing was bought to work together", pain: 70, solvedBy: ["consulting", "service", "digital-product", "content"], alternative: "buying more of the same" },
      { id: "listing-quality", label: "Items that don't sell", statement: "Resellers price and photograph badly and blame the market when nothing moves", pain: 72, solvedBy: ["service", "education", "productized-service"], alternative: "dropping the price repeatedly" },
      { id: "occasion-panic", label: "A deadline and no outfit", statement: "Events create urgent, high-stakes decisions people are badly equipped to make quickly", pain: 82, solvedBy: ["service", "consulting", "local-service"], alternative: "panic-buying something worn once" },
      { id: "adaptive-gap", label: "Clothing that ignores real bodies", statement: "People with non-standard requirements are underserved by nearly everything on the market", pain: 84, solvedBy: ["ecommerce", "local-service", "community", "content"], alternative: "adapting things themselves" },
    ],
  }),
  ...
  I({
    ...
    problems: [
      { id: "manual-work", label: "Work done by hand every week", statement: "Teams spend hours on repetitive copying and reformatting that a small script would end permanently", pain: 82, solvedBy: ["service", "software", "consulting", "productized-service"], alternative: "an intern, or accepting it" },
      { id: "dead-website", label: "A website that does nothing", statement: "Most small business sites are brochures that generate no enquiries and nobody knows why", pain: 74, solvedBy: ["service", "productized-service", "agency", "consulting"], alternative: "paying a monthly fee for a site nobody visits" },
      { id: "tool-sprawl", label: "Too many disconnected tools", statement: "Businesses pay for a dozen tools that don't talk to each other, so data gets retyped constantly", pain: 76, solvedBy: ["consulting", "service", "software"], alternative: "more spreadsheets bridging the gaps" },
      { id: "tech-helplessness", label: "Stuck with nobody to ask", statement: "People lose hours or money to problems a competent person would fix in ten minutes", pain: 80, solvedBy: ["local-service", "service", "education"], alternative: "asking a relative who is also guessing" },
      { id: "capacity", label: "Agencies turning work away", statement: "Small studios refuse profitable work because they have no reliable overflow capacity", pain: 74, solvedBy: ["service", "agency", "consulting"], alternative: "saying no, or delivering late" },
    ],
  }),
  ...
  I({
    ...
    problems: [
      { id: "no-idea-where", label: "Told to use AI, no idea where", statement: "Businesses know they're supposed to be using these tools and have no framework for finding the useful applications", pain: 74, solvedBy: ["consulting", "education", "service"], alternative: "a paid subscription nobody opens" },
      { id: "bad-output", label: "Output that needs rewriting anyway", statement: "Generic prompting produces work that takes as long to fix as it would have taken to write", pain: 76, solvedBy: ["consulting", "education", "digital-product", "service"], alternative: "concluding the tools don't work" },
      { id: "repetitive-writing", label: "The same document, endlessly", statement: "Teams rewrite near-identical proposals, reports and replies from scratch every time", pain: 78, solvedBy: ["service", "software", "productized-service", "consulting"], alternative: "copy-pasting the last one and missing edits" },
      { id: "trust-accuracy", label: "Not knowing when to trust it", statement: "People can't tell confident nonsense from correct output, so they either over-trust or abandon it", pain: 80, solvedBy: ["education", "consulting", "content"], alternative: "checking nothing, or checking everything" },
      { id: "workflow-glue", label: "Nothing joins up", statement: "Useful tools sit in isolation because nobody has connected them to where the work actually happens", pain: 74, solvedBy: ["service", "software", "consulting"], alternative: "manual copying between tabs" },
    ],
  ...
  I({
    ...
    problems: [
      { id: "nothing-specific", label: "Mass-market products that nearly fit", statement: "Niche requirements get served by products designed for someone else, and buyers settle every time", pain: 76, solvedBy: ["ecommerce", "productized-service", "community"], alternative: "buying the closest thing and modifying it" },
      { id: "listing-conversion", label: "Traffic that doesn't convert", statement: "Sellers get views and no sales because their photos and descriptions answer none of the buyer's real questions", pain: 74, solvedBy: ["service", "consulting", "productized-service", "education"], alternative: "running ads at a page that doesn't work" },
      { id: "sourcing", label: "Not knowing where to source", statement: "Would-be sellers stall permanently at finding a supplier they can trust at small volumes", pain: 72, solvedBy: ["consulting", "education", "digital-product"], alternative: "abandoning the idea" },
      { id: "margins", label: "Selling plenty, earning nothing", statement: "Sellers discover after months that fees, shipping and returns left almost no margin", pain: 80, solvedBy: ["consulting", "education", "software", "digital-product"], alternative: "raising prices blindly or working harder" },
      { id: "gift-generic", label: "Gifts that feel thoughtless", statement: "Buyers want something personal and end up with the same candle everyone else bought", pain: 70, solvedBy: ["ecommerce", "productized-service", "local-service"], alternative: "a gift card" },
    ],
  ...
  I({
    ...
    problems: [
      { id: "first-timer", label: "Planning something you'll do once", statement: "Nobody develops competence at an event they organise once, so avoidable mistakes are near-universal", pain: 82, solvedBy: ["service", "consulting", "digital-product", "education"], alternative: "spreadsheets, forums and hope" },
      { id: "supplier-risk", label: "Suppliers who let you down", statement: "One unreliable supplier can ruin an unrepeatable day, and there's no good way to vet them", pain: 84, solvedBy: ["service", "marketplace", "consulting"], alternative: "reviews of unknown provenance" },
      { id: "day-of-chaos", label: "Nobody running the day itself", statement: "Plans exist and nobody is responsible for executing them while the hosts are busy being hosts", pain: 80, solvedBy: ["local-service", "service", "events"], alternative: "a relative doing it badly" },
      { id: "photo-regret", label: "Nothing worth keeping afterwards", statement: "Guests take hundreds of poor photos and the moments people actually wanted are missed", pain: 76, solvedBy: ["local-service", "productized-service", "service"], alternative: "phone photos and disappointment" },
      { id: "empty-venue", label: "Venues empty midweek", statement: "Small venues have dead capacity and no marketing capability to fill it", pain: 72, solvedBy: ["agency", "consulting", "events", "service"], alternative: "waiting for enquiries" },
    ],
  }),
  ...
  I({
    ...
    problems: [
      { id: "no-feedback", label: "Playing without feedback", statement: "Most amateur players never see themselves play and repeat the same mistakes for years", pain: 74, solvedBy: ["service", "education", "content", "software"], alternative: "occasional advice from a teammate" },
      { id: "recruiting-maze", label: "The selection process is opaque", statement: "Families spend thousands on the wrong showcases because nobody explains how selection actually works", pain: 84, solvedBy: ["consulting", "education", "service", "digital-product"], alternative: "following whatever another parent did" },
      { id: "club-admin", label: "Clubs run on volunteer goodwill", statement: "Fixtures, subs, kit and communication all fall on one exhausted volunteer", pain: 78, solvedBy: ["service", "software", "consulting"], alternative: "chaotic group chats and unpaid subs" },
      { id: "highlight-gap", label: "No footage worth showing", statement: "Players need highlight material and end up with shaky sideline phone video", pain: 76, solvedBy: ["local-service", "productized-service", "service"], alternative: "a parent filming from the touchline" },
      { id: "injury-prevention", label: "Preventable injuries", statement: "Amateur players get hurt doing things that basic preparation would have prevented", pain: 72, solvedBy: ["education", "content", "service"], alternative: "playing through it" },
    ],
  }),
  ...
  I({
    ...
    problems: [
      { id: "decision-overload", label: "Too many decisions, no system", statement: "Households run on constant improvisation, and the mental load falls entirely on one person", pain: 80, solvedBy: ["service", "consulting", "digital-product", "community"], alternative: "coping until something breaks" },
      { id: "stuff", label: "Decades of accumulated belongings", statement: "Sorting a lifetime of possessions under a moving deadline is emotionally and physically beyond most people", pain: 84, solvedBy: ["local-service", "service"], alternative: "a skip and regret" },
      { id: "no-village", label: "Nobody to ask", statement: "Families are geographically scattered, so ordinary questions have no trusted answer", pain: 76, solvedBy: ["community", "service", "education", "content"], alternative: "conflicting internet advice at 3am" },
      { id: "admin-for-others", label: "Managing someone else's affairs", statement: "Carers inherit a second household's paperwork with no handover and no training", pain: 82, solvedBy: ["service", "consulting", "education", "digital-product"], alternative: "learning by crisis" },
      { id: "home-costs", label: "Money leaking from the household", statement: "Families overpay on recurring costs for years because reviewing them is nobody's job", pain: 74, solvedBy: ["service", "consulting", "education"], alternative: "auto-renewing everything" },
    ],
  }),
];
