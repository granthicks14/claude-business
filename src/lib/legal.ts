...
export const ACCESSIBILITY_STATEMENT = {
  target: "WCAG 2.2 AA",
    ...
    "Menus, tab strips and dialogs do what their role promises: arrow keys and Home/End move between items, Escape closes a menu and puts focus back on the button that opened it, and the keyboard cannot wander out of an open dialog behind it. (check:a11y opens the account menu and the phase tabs and presses those keys, and counts how many of twenty Tab presses escape an open dialog.)",
