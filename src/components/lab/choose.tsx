 ...
 * Choosing one.
 *
 * Was `/best`. Ten angles over the same shortlist — the last step of the loop,
 * and the one a beginner most needs, because "which of these fifteen" is a
 * harder question than "give me fifteen".
 */
    ...
    return (
      <div className="space-y-6">
        <p className="text-sm text-muted leading-relaxed">
          You don&apos;t need to understand business for this. It looks at everything you&apos;ve told us and sorts the
          options into ten plain-language angles.
        </p>
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <p className="text-sm text-muted leading-relaxed max-w-xl">
          Your {state.ideas.length} ideas, sorted ten ways. The same idea can win more than one — that&apos;s usually a
          strong signal.
        </p>
