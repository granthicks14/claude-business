...
/**
 * The shortlist: everything generated so far, filtered and ranked.
 *
 * Was `/ideas`. The list is the middle of the loop, not a destination — you
 * arrive here from generating and leave for choosing, which is why it stopped
 * being its own route.
 */
        ...
        <>
          ...
          <Card className="p-5 flex flex-wrap items-center gap-3">
            ...
            <div className="flex gap-2">
              ...
              <LinkButton href="/lab?tab=choose" variant="primary" icon={<Icon.target />}>
                Find my best
              </LinkButton>
            </div>
          </Card>
